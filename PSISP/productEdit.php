...
<div class="wrapper">
  ...
  <h3>Choose a field to Edit and click the save button</h3> 
      ...
      <form method="post" action="productEdit.php" name="registration" class="form-horizontal">
...
<option>PPrice</option>
<option selected="selected">SPrice</option>
...
<div class="col-sm-8">
<input type="number" name="ProductId" id="ProductId"  class="form-control"  required="required">
...
if(isset($_POST['save'])){
          require_once'database.php';
            ...
            if($_POST['dep']=="productName"){             
             ...
             else if($_POST['dep']=="PPrice"){
                $field="PPrice";
            }
             else if($_POST['dep']=="SPrice"){
                $field="SPrice";
            }
           ...
           $d=mysqli_query($con,"update product set $field='$value' where ProductId=$ProductId");
