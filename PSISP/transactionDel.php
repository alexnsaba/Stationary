...
<div class="wrapper">
  ...
  <h3>Enter the TransctionId and click the Delete button</h3> 
                <div class="panel-body">
      <form method="post" action="transactionDel.php" name="registration" class="form-horizontal">
...
if(isset($_POST['delete'])){
          require_once'database.php';              
           ...
           $d=mysqli_query($con,"delete from transaction where TransactionId=$transactionId");
       
              if($d){
               echo"<br/><p style='color:blue;font-size:20pt'> <i class='fa fa-check'></i> The Transaction ".$transactionId." is deleted successfully</p>";
              
       }
       else {       
       echo"<br/><p style='color:blue;font-size:20pt'> <i class='fa fa-close'></i> Failed to delete the transaction.</p>";
       } 
       mysqli_close($con);       
       }   
