...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h2>Enter Details of the new products</h2>  
                <div class="panel-body"> 

  <form method="post" action="newProducts.php" enctype="multipart/form-data" name="registration" class="form-horizontal">
...
<div class="col-sm-8">
<input type="text" name="pName" id="pName"  class="form-control" required="required" >
</div>
</div>
...
<div class="col-sm-8">
<input type="number" name="pPrice" id="pPrice"  class="form-control" required="required" placeholder="The price at which you bought the commmodity" >
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Selling Price  </label>
<div class="col-sm-8">
<input type="number" name="sPrice" id="sPrice"  class="form-control" required="required" placeholder="The price at which you will sell the commmodity" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="qty" id="qty"  class="form-control" required="required" placeholder="Number of products">
</div>
</div>
...
// obtaining form parameters
  ...
  $name=$rw['name'];
   ...
   $a= mysqli_query($con,"insert into product(productName,PPrice,SPrice,Quantity,date,ResponsilePerson) 
    values('$pName','$pPrice','$sPrice','$qty','$date','$name')");
   if($a){
